if [ -d ./libjpeg-turbo/cmake/${ANDROID_ABI} ]; then

cd ./libjpeg-turbo/cmake/${ANDROID_ABI}

else

mkdir -p ./libjpeg-turbo/cmake/${ANDROID_ABI}
cd ./libjpeg-turbo/cmake/${ANDROID_ABI}
