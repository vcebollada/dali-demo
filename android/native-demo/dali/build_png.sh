if [ -d ./libpng/cmake/${ANDROID_ABI} ]; then

cd ./libpng/cmake/${ANDROID_ABI}

else

mkdir -p ./libpng/cmake/${ANDROID_ABI}
cd ./libpng/cmake/${ANDROID_ABI}
