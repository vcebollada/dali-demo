if [ -d ./libexpat/cmake/${ANDROID_ABI} ]; then

cd ./libexpat/cmake/${ANDROID_ABI}

else

mkdir -p ./libexpat/cmake/${ANDROID_ABI}
cd ./libexpat/cmake/${ANDROID_ABI}
